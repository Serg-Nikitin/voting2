...
import ru.nikitin.voting.web.GlobalExceptionHandler;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(UserTestData.USER_MATCHER.contentJson(UserTestData.admin, UserTestData.user, UserTestData.user1, UserTestData.user2, UserTestData.user3, UserTestData.user4, UserTestData.user5));
    }
